...
class ExceptionListener extends BaseExceptionListener
{
    ...
    {
        //cette methode permet de conserver une url demandée pour la réutiliser
        ...
        //     alors on me redirige vers le form de login et suite à la connexion, je suis redirigé vers cette derniere page
